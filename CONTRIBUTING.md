# Contributing to @noobdigital/react-native-dynamic-island
...
- Search [existing issues](https://github.com/NoobDigital/react-native-dynamic-island/issues) and pull requests before opening a new one.
...
For Live Activity, Dynamic Island, lock-screen notification, deep-linking, or lifecycle changes, test start, update, restore, and end behavior. State which tests used a physical device. Include fallback behavior for unsupported OS versions and devices.
