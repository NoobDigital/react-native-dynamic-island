...
Platform behavior is governed by iOS, Android, ActivityKit, WidgetKit, notification permissions, power management, and OEM policies. Visual differences or operating-system restrictions are not security vulnerabilities unless this package exposes data, bypasses a permission boundary, or creates another concrete security impact.
